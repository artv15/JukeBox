 ...
 *
 *    Keep the ElementsTreesalliancejukedisksMod object in this class and all calls to this object
...
public class TreesalliancejukedisksMod {
	...
	@Mod.Instance(MODID)
	public static TreesalliancejukedisksMod instance;
	public ElementsTreesalliancejukedisksMod elements = new ElementsTreesalliancejukedisksMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsTreesalliancejukedisksMod.GuiHandler());
