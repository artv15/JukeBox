...
package net.mcreator.treesalliancejukedisks.gui;
...
public class GuiErroreRefiner extends ElementsTreesalliancejukedisksMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiErroreRefiner(ElementsTreesalliancejukedisksMod instance) {
		super(instance, 51);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 16, 26) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 16, 62) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 133, 44) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				TreesalliancejukedisksMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("treesalliancejukedisks:textures/errore_refiner.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			TreesalliancejukedisksMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
